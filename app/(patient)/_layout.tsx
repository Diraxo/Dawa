...
// which otherwise instantly bounces an already-signed-in patient out of
...
export default function PatientLayout() {
  ...
  useEffect(() => {
    ...
    const guardFails = !isSignedIn || userRole !== 'patient'

    if (!guardFails) {
      // Signed in with the right role — clear guards so a future real
      // sign-out can trigger the redirect again.
    ...
    // doctor account on this patient layout) is not this case and still
