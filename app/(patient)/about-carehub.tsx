...
const CORE_VALUES = [
  {
    ...
    title: 'Trust & Safety',
    desc: 'Every doctor is verified by our admin team before joining the platform.',
  },
  {
    icon: 'globe',
    color: colors.interactiveBlue,
    title: 'Accessibility',
    desc: 'Bringing quality healthcare to underserved communities across Africa and beyond.',
  },
  {
    icon: 'lock-closed',
    color: colors.careBlue,
    title: 'Privacy First',
    desc: 'Your health data belongs to you. We enforce strict encryption and access controls.',
  },
  {
    icon: 'flash',
    color: '#F59E0B',
    title: 'Speed & Reliability',
    desc: 'Instant consultations — no waiting rooms, no commute.',
  },
]
...
export default function AboutCareHubScreen() {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>About CareHub</Text>
        <View style={{ width: 36 }} />
      </View>
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardBody}>
            CareHub was built with one goal: to eliminate the barriers between patients and quality
            healthcare. We believe everyone — regardless of location, income, or circumstance —
            deserves fast access to a trusted doctor.
          </Text>
          <Text style={[styles.cardBody, { marginTop: 10 }]}>
            Through real-time chat, audio calls, and video consultations, we connect patients with
            verified healthcare professionals across Ethiopia, Rwanda, Somalia, and beyond.
          </Text>
        </View>
        ...
        {/* How it works */}
        <View style={styles.card}>
          <Text style={styles.cardTitle}>How CareHub Works</Text>
          {[
            { step: '1', text: 'Create a free account and complete your profile.' },
            { step: '2', text: 'Browse verified doctors by specialty, rating, and availability.' },
            { step: '3', text: 'Book a chat, phone, or video consultation.' },
            { step: '4', text: 'Connect instantly — the doctor has 30 seconds to accept.' },
            { step: '5', text: 'Receive a detailed consultation summary and follow-up notes.' },
          ].map((item) => (
        ...
        <View style={styles.card}>
          ...
          {[
            { icon: 'mail-outline', text: 'support@carehub.app' },
            { icon: 'globe-outline', text: 'www.carehub.app' },
        ...
        <Text style={styles.copyright}>© {new Date().getFullYear()} CareHub. All rights reserved.</Text>
