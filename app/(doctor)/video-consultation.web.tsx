    ...
    <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
      <View style={styles.center}>
        <View style={styles.iconCircle}>
          <Ionicons name="videocam-outline" size={48} color={colors.tealGreen} />
        </View>
        <Text style={styles.title}>Video Calls Require the App</Text>
        <Text style={styles.body}>
          Video consultations are available on the Dawa Android app. Please use the app to conduct video calls with patients.
        </Text>
