...
import { Home, Stethoscope, Calendar, MessageCircle, User, LogOut, FileText, Bell, HelpCircle, Info, CreditCard, Download } from 'lucide-react'
...
const secondaryItems = [
  ...
  { icon: Download, label: 'Export My Data', href: '/patient/data-export' },
...
export default function PatientSidebar() {
  ...
  return (
    <aside className="w-64 min-h-screen bg-white border-r border-steel-grey flex flex-col">
      ...
      {/* Nav */}
      <nav className="flex-1 px-3 py-4 flex flex-col gap-1 overflow-y-auto" aria-label="Patient navigation">
        {navItems.map(item => {
