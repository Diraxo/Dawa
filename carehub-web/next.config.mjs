...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.clerk.com https://*.clerk.accounts.dev https://challenges.cloudflare.com https://*.agora.io wss://*.agora.io:* https://*.sd-rtn.com wss://*.sd-rtn.com:* https://*.stream-io-api.com wss://*.stream-io-api.com https://*.stream-io-cdn.com",
      "media-src 'self' blob:",
